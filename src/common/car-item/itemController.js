			...
			self.service.getCar(carId)
				.then(function(data){
					...
					var carInfoNeeded = {
						...
						title : carInfo.result.auto_data.marka_data.name + ' ' + 
							carInfo.result.auto_data.model_data.name + ' ' + carInfo.result.auto_data.version,
						...
						date : carInfo.result.date_data.date_add.day + '.' + 
							carInfo.result.date_data.date_add.full_month+'.'+carInfo.result.date_data.date_add.year,
						...
						transmission : carInfo.result.auto_data.gearbox_data ? 
							carInfo.result.auto_data.gearbox_data.name : '---',
