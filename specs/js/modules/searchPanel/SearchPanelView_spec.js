...
var View = require(env.furtherPathToSrcFolder + 'modules/searchPanel/SearchPanelView.js')(env.window, env.window.document);
...
//
//        self.$searchForm        = document.querySelector('[data-searchPanel=form]');
